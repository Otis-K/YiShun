import type { CanvasNode, CanvasNodeData, GraphDocument, Point } from './core/types.cjs';
import type { RuntimeConfigurationRequiredLike } from './runtime/errors.cjs';
...
export interface FlowCanvasAssetService {
    ...
    pickFiles: (request: FlowCanvasAssetRequest) => readonly FlowCanvasAssetNode[] | Promise<readonly FlowCanvasAssetNode[]>;
}
...
export interface FlowCanvasAssistantService {
    ...
    send: (request: FlowCanvasAssistantRequest) => string | FlowCanvasAssistantReply | Promise<string | FlowCanvasAssistantReply>;
}
